...
test('Login to Sauce Demo with valid credentials', async({page}) =>{
...
test('Login to Sauce Demo with invalid credentials', async({page}) =>{
...
test('Login to Sauce Demo with invalid username only', async({page}) =>{
    const lp = new LoginPage(page);
...
test('Login to Sauce Demo with invalid password only', async({page}) =>{
    const lp = new LoginPage(page);
...
test('Complete the purchase for 2 items which has $15.99 price.', async({page}) =>{
    // const hp = new HomePage(page);
    const lp = new LoginPage(page);
    const pp = new ProductsPage(page);
...
test('Validate the locked_out_user', async({page}) =>{
    const lp = new LoginPage(page);
